...
class CollectionTest extends \PHPUnit_Framework_TestCase {
     ...
     * @expectedExceptionMessage Entity Base\Domain\Entity has no method getDfgjksn
     */
    ...
    /**
     * @expectedException \RuntimeException
     * @expectedExceptionMessage Entity Base\Domain\Entity has no method getStatus
     */
    ...
    public function testGetByAttributeValueWithEmptyCollectionReturnEntity() {
        ...
        $this->assertEquals(new EntityWithName(), $collection->getByAttributeValue(1, 'id', 'BaseTest\Domain\Assets\EntityWithName'));
    }
