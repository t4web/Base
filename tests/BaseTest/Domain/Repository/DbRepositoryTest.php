...
class DbRepositoryTest extends \PHPUnit_Framework_TestCase {
    ...
    public function setUp() {
        $this->dbMapperMock = $this->getMock('Base\Domain\Mapper\DbMapperInterface');
        $this->queryBuilderMock = $this->getMock('Base\Db\QueryBuilderInterface');
        $this->tableGatewayMock = $this->getMock('Base\Db\TableGatewayInterface');
    ...
    public function testFindMany($rows) {
        ...
        $expectedCollection =  new \Base\Domain\Collection();
        
        $entity1 = new \Base\Domain\Entity($rows[0]);
        $expectedCollection->offsetSet($rows[0]['id'], $entity1);
        
        $entity2 = new \Base\Domain\Entity($rows[1]);
        ...
        $identityMap =  new \Base\Domain\Repository\IdentityMap();
    ...
    public function testAddExistingEntity() {
        ...
        $identityMapMock = $this->getMock('Base\Domain\Repository\IdentityMap');
    ...
    public function testAddNewEntityWithId() {
        $id = 111;
        $entity = new \Base\Domain\Entity(array('id' => $id));
    ...
    public function testFind() {
        ...
        $expectedEntityMock = $this->getMock('Base\Domain\EntityInterface');
