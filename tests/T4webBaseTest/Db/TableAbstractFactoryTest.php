...
namespace T4webBaseTest\Domain\Source;

use T4webBase\Db\TableAbstractFactory;
...
class TableGatewayAbstractFactoryTest extends \PHPUnit_Framework_TestCase {
    ...
    public function testCreateServiceWithName() {
        ...
        $tableGatewayMock = $this->getMockBuilder('T4webBase\Db\TableGateway')
                ->disableOriginalConstructor()
                ->getMock();
        ...
        $this->assertInstanceOf('T4webBase\Db\Table', $tableGateway);
