...
namespace T4webBase\Tests\Domain\Service;
...
class CreateTest extends \PHPUnit_Framework_TestCase {
    ...
    public function testImplementCreateInterface() {
        $this->assertInstanceOf('T4webBase\Domain\Service\CreateInterface', $this->createService);
    }
    ...
    public function testGetErrors() {
        ...
        $this->assertInstanceOf('T4webBase\InputFilter\InvalidInputError', $error);
