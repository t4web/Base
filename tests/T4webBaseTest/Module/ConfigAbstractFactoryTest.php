...
class ConfigAbstractFactoryTest extends \PHPUnit_Framework_TestCase {
    ...
    public function testCreateServiceWithNameWithBadModuleConfig() {
        $someConfig = null;
        $moduleName = 'Foo';
        ...
        $this->setExpectedException('RuntimeException', "Cannot load config for module $moduleName");

        $abstractFactory->createServiceWithName($serviceLocatorMock, $name = 'foo', "$moduleName\\ModuleConfig");
    }
